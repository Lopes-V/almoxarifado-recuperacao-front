...
function classificacao(ocupacao:number){
    const className = `<div className="h-full w-[${ocupacao}%] bg-emerald-500"></div>`
    if(ocupacao >= 0 && ocupacao <= 20) return <div className="mt-5 h-3 bg-zinc-100"></div>
    if(ocupacao > 20 && ocupacao <= 40) return <div className="mt-5 h-3 bg-zinc-100">{className}</div>
