...
function classificacao(ocupacao: number) {
    ...
    if (ocupacao > 80 && ocupacao <= 90) {const className = `<div className="h-full w-[${ocupacao}%] bg-rose-600"></div>`; return <div className="mt-5 h-3 bg-zinc-100"></div>}
    if (ocupacao > 90) return <div className="mt-5 h-3 bg-zinc-100"><div className="h-full w-[4%] bg-rose-800"></div></div>
}
