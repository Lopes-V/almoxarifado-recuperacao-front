...
export default async function Posicao({  searchParams }: { searchParams: Promise<{ [key: string]: string | string[] | undefined }> }) {

    const idPosicao = await searchParams
    try {
        const response = await fetch(`https://api-warehouse-k0ex.onrender.com/api/posicoes/${searchParams}`);
