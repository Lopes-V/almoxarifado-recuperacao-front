...
function classificacao(ocupacao: number) {
    if (ocupacao >= 0 && ocupacao <= 20) {  return = `<div className="h-full w-[${ocupacao}%] bg-emerald-500"></div>`; return <div className="mt-5 h-3 bg-zinc-100">{className}</div> }
    if (ocupacao > 20 && ocupacao <= 40) {  return = `<div className="h-full w-[${ocupacao}%] bg-green-500"></div>`; return <div className="mt-5 h-3 bg-zinc-100">{className}</div> }
    if (ocupacao > 40 && ocupacao <= 55) {  return = `<div className="h-full w-[${ocupacao}%] bg-lime-500"></div>`; return <div className="mt-5 h-3 bg-zinc-100">{className}</div> }
    if (ocupacao > 55 && ocupacao <= 65) {  return = `<div className="h-full w-[${ocupacao}%] bg-amber-400"></div>`; return <div className="mt-5 h-3 bg-zinc-100">{className}</div> }
    if (ocupacao > 65 && ocupacao <= 80) {  return = `<div className="h-full w-[${ocupacao}%] bg-orange-500"></div>`; return <div className="mt-5 h-3 bg-zinc-100">{className}</div> }
