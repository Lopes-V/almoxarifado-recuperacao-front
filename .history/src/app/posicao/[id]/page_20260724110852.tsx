...
function classificacao(ocupacao: number) {
    ...
    if (ocupacao > 80 && ocupacao <= 90) { return `<div className="h-full w-[${ocupacao}%] bg-rose-600"></div>`; }
    if (ocupacao > 90) { return `<div className="h-full w-[${ocupacao}%] bg-rose-800"></div>`; }
}
                    ...
                    <section className="mt-6 grid gap-6 lg:grid-cols-[1fr_360px]">
                        ...
                        <aside className="space-y-6">
                            <section className="border border-zinc-200 bg-white p-6 shadow-sm">
                                ...
                                {/* {<div className="mt-5 h-3 bg-zinc-100">{classificacao(data.percentual_ocupacao)}</div>} */}
