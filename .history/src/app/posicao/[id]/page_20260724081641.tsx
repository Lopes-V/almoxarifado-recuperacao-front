                        ...
                        <article className="border border-zinc-200 bg-white shadow-sm">
                            ...
                            <div className="p-6">
                                ...
                                <dl className="mt-8 grid gap-px overflow-hidden border border-zinc-200 bg-zinc-200 sm:grid-cols-2">
                                    ...
                                    <div className="bg-white p-5"><dt className="text-xs font-bold uppercase tracking-[0.18em] text-zinc-500">Peso atual</dt><dd className="mono mt-2 text-xl font-bold">{data.pe} kg</dd></div>
