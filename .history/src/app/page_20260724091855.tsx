            ...
            <aside className="space-y-6">
              <section className="border border-zinc-200 bg-white p-5 shadow-sm">
                ...
                <div className="mt-5 space-y-5">
                  ...
                  <div><div className="mb-2 flex justify-between text-sm"><strong>Atenção</strong><span className="mono text-xs text-zinc-500">{statusNormal(data)} · {divisaoStatus(data,sta(data))}%</span></div><div className="h-1.5 bg-zinc-100"><div className="h-full w-[38%] bg-amber-400"></div></div></div>
