...
function classificacao(ocupacao: number) {
    ...
    if (ocupacao > 40 && ocupacao <= 55) { return `border-b border-r border-white bg-amber-400 p-5 text-center text-white hover:brightness-95`}
    ...
    if (ocupacao > 65 && ocupacao <= 80) { return `border-b border-r border-white bg-amber-400 p-5 text-center text-white hover:brightness-95`}
    if (ocupacao > 80 && ocupacao <= 90) { return `border-b border-r border-white bg-amber-400 p-5 text-center text-white hover:brightness-95`}
    if (ocupacao > 90) { return `border-b border-r border-white bg-amber-400 p-5 text-center text-white hover:brightness-95` }
}
