            ...
            <aside className="space-y-6">
              ...
              <section className="border border-zinc-200 bg-white p-5 shadow-sm">
                ...
                <div className="mt-5 space-y-5">
                  ...
                  <div><div className="mb-2 flex justify-between text-sm"><strong>Corredor D</strong><span className="mono text-xs text-zinc-500">% · {corredorD(data)} pos</span></div><div className="h-1.5 bg-zinc-100"><div className="h-full w-[59%] bg-blue-800"></div></div></div>
                </div>
              </section>
            </aside>
          </section>
