          ...
          <section className="mt-6 grid gap-6 xl:grid-cols-[minmax(0,2fr)_minmax(320px,0.95fr)]">
            ...
            <aside className="space-y-6">
              ...
              <section className="border border-zinc-200 bg-white p-5 shadow-sm">
                ...
                <div className="mt-5 space-y-5">
                  <div><div className="mb-2 flex justify-between text-sm"><strong>Corredor A</strong><span className="mono text-xs text-zinc-500">{divisaoCorredor(data,corredorD(data))}% · {corredorA(data)} pos</span></div><div className="h-1.5 bg-zinc-100"><div className="h-full w-[44%] bg-blue-800"></div></div></div>
                  <div><div className="mb-2 flex justify-between text-sm"><strong>Corredor B</strong><span className="mono text-xs text-zinc-500">{divisaoCorredor(data,corredorD(data))}% · {corredorB(data)} pos</span></div><div className="h-1.5 bg-zinc-100"><div className="h-full w-[65%] bg-blue-800"></div></div></div>
