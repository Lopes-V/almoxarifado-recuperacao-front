            ...
            <aside className="space-y-6">
              <section className="border border-zinc-200 bg-white p-5 shadow-sm">
                ...
                <div className="mt-5 space-y-5">
                  <div><div className="mb-2 flex justify-between text-sm"><strong>Normal</strong><span className="mono text-xs text-zinc-500">{} · 58%</span></div><div className="h-1.5 bg-zinc-100"><div className="h-full w-[58%] bg-emerald-600"></div></div></div>
