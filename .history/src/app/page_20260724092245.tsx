            ...
            <aside className="space-y-6">
              ...
              <section className="border border-zinc-200 bg-white p-5 shadow-sm">
                ...
                <div className="mt-5 space-y-5">
                  ...
                  <div><div className="mb-2 flex justify-between text-sm"><strong>Corredor C</strong><span className="mono text-xs text-zinc-500">76% · {corre} pos</span></div><div className="h-1.5 bg-zinc-100"><div className="h-full w-[76%] bg-blue-800"></div></div></div>
