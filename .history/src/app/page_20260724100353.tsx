...
//
der-r border-white bg-orange-500 p-5 text-center text-white hover:brightness-95"><span className="mono block text-xs font-bold">D4-06</span><strong className="mono mt-1 block text-2xl">78%</strong></a>
...
function filtrarNivel(data:posicao[],nivel: string) {
  ...
  data.map(e => if(e.corredor === "Corredor A"){
    ...
    <span className="mono block text-xs font-bold">A1-06</span><strong className="mono mt-1 block text-2xl">60%</strong></a>`
  })
