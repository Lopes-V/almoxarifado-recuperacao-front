...
function corredoresAtivos(posicao : posicao[]){
        ...
        <main className="mx-auto max-w-360 px-6 py-8 lg:px-10">
          ...
          <section className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
            <article className="border border-zinc-200 bg-white p-6 shadow-sm">
              ...
              <p className="mono mt-5 text-5xl font-semibold text-blue-800">24</p>
              <p className="mt-2 text-xs text-zinc-500">{data.length} corredores ativos</p>
            </article>
            <article className="border border-zinc-200 bg-white p-6 shadow-sm">
              <div className="flex items-start justify-between">
              ...
              <p className="mono mt-5 text-5xl font-semibold text-emerald-600">60.9<span className="ml-1 text-xl text-zinc-500">%</span></p>
              <p className="mt-2 text-xs text-zinc-500">8.251,5 kg / 13.900 kg</p>
            </article>
            <article className="border border-zinc-200 bg-white p-6 shadow-sm">
              <div className="flex items-start justify-between">
