...
function ocupacaoMedia(posicao : posicao[]){
  let media : number = 0;
  posicao.map(e =>  media += e.percentual_ocupacao)
  media = media / posicao.length
}
        ...
        <main className="mx-auto max-w-360 px-6 py-8 lg:px-10">
          ...
          <section className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
            ...
            <article className="border border-zinc-200 bg-white p-6 shadow-sm">
              ...
              <p className="mono mt-5 text-5xl font-semibold text-emerald-600">{ocupacaoMedia())}<span className="ml-1 text-xl text-zinc-500">%</span></p>
