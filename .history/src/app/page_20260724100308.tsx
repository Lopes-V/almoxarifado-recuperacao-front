...
function filtrarNivel(data:posicao[],nivel: string) {
  <a href="posicao.html" className="border-b border-r border-white bg-amber-400 p-5 text-center text-white hover:brightness-95">
    <span className="mono block text-xs font-bold">A1-06</span><strong className="mono mt-1 block text-2xl">60%</strong></a>
  let html : string= ""
  html += data.map(e => if(e.corredor === "Corredor A")
