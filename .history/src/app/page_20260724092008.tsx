...
// <div><div className="mb-2 flex justify-between text-sm"><strong>Normal</strong><span className="mono text-xs text-zinc-500">{statusNormal(data)}
//  · {divisaoStatus(data,statusNormal(data))}%</span></div><div className="h-1.5 bg-zinc-100"><div className="h-full w-[58%] bg-emerald-600"></div></div></div>
